...
for exec_type in exec_types:
    ...
    for state_id, state in tqdm(enumerate(states[:-1])):
        InputFile1 = rf'/home/xuyi/morphing/test_files/spliceosome_{state}_{exec_type}.pdb'
        InputFile2 = rf'/home/xuyi/morphing/test_files/spliceosome_{states[state_id+1]}_{exec_type}.pdb'
        ReferenceFile = rf'/home/xuyi/morphing/test_files/spliceosome_B_5zwo_A_{exec_type}.pdb'
        OutputFile = rf'/home/xuyi/morphing/test_files/spliceosome_{state}_{states[state_id+1]}_{exec_type}_0308.pdb'
        num_frames = 20
